...
const Signup = () => {
    return (
        <>
            ...
            <h1 className=' mt-20 font-semibold text-4xl tracking-wide mx-72'>Register here For Daily dozes Of News</h1>
            <div>
                <section className="text-gray-600 body-font ">
                    <div className="container px-5 py-24 mx-auto">
                        <div className="flex flex-col text-center w-full mb-12">
                            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">India No.1 News App</h1>
                            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Fill below details to get free daily News</p>
                        </div>
                        <div className="lg:w-1/2 md:w-2/3 mx-auto">
                            <div className="flex flex-wrap -m-2">
                                <div className="p-2 w-1/2  sss">
                                    <div className="">
                                ...
                                <div className="p-2 w-1/2">
                                    <div className="">
                                        ...
                                        <input type="password" id="email" name="email" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                    </div>
                                </div>
                                <div className="p-2 w-full">
                                    <div className="relative">
                                        <label htmlFor="message" className="leading-7 text-sm text-gray-600">Any Message</label>
